...
public class RecyclerViewAdapterUsers extends RecyclerView.Adapter<RecyclerViewAdapterUsers.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapterUsers(ArrayList<UserClass> userObjectArray, Context context) {
